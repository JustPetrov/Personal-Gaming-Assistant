...
<section class="wide"><h2>GamesCom Events</h2>{event_html}</section>'''
    ...
    def watchers_page():
        state = _observations()
        groups = {
            "Games": ["SteamDB", "Steam", "PS Store", "Wishlist", "Game Price", "EPIX", "GamesCom Tickets"],
            "Hardware": ["Hardware", "GPU", "RAM", "CPU", "Tweakers", "Retailers"],
            "Discord": ["Discord Price", "Discord News", "Discord Alerts"],
            "GamesCom": ["Hotel Watcher", "Ticket Watcher", "Announcements", "EPIX", "Travel List"],
            "System": ["Monitoring Cycle", "Change Detection", "Price History", "Notifications", "Watcher Registry"],
        }
