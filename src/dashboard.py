...
<section class="card wide"><h2>Wishlist</h2><p><button onclick="addWish()">＋ Toevoegen</button></p><div id="wishlist">Laden...</div></section>
...
<script>
const get=async u=>(await fetch(u)).json();function esc(s){return String(s??'').replaceAll('&','&amp;').replaceAll('<','&lt;').replaceAll('>','&gt;')}
